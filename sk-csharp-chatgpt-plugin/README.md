...
1. Copy [settings.json.openai-example](./config-samples/appsettings.json.openai-example) to `./appsettings.json`
...
1. Copy [settings.json.azure-example](./config-samples/appsettings.json.azure-example) to `./appsettings.json`
