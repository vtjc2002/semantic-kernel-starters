...
1. Copy [settings.json.openai-example](./azure-function/config/appsettings.json.openai-example) to `./appsettings.json`
...
1. Copy [settings.json.azure-example](./azure-function/config/appsettings.json.azure-example) to `./appsettings.json`
